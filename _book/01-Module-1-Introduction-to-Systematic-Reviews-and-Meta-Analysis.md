...
Learn why systematic reviews are critical for synthesizing research and informing decisions.

●	How to register your study protocol:

Explore the process and benefits of registering your systematic review protocol to ensure transparency and reduce bias.

Detailed overview of the lesson topics:

●	Definition and importance: Gain a clear understanding of what systematic reviews are and why they matter.

●	Guide to registering a study protocol: Learn the steps and best practices for registering your review protocol.

●	PRISMA guidelines: Get introduced to the PRISMA framework, which guides the transparent reporting of systematic reviews.

●	Steps in conducting a systematic review: Overview of the key stages involved in performing a systematic review, from question formulation to data extraction and synthesis.

●	Assessing methodological quality — AMSTAR 2: Introduction to AMSTAR-2, a tool used to evaluate the quality and confidence of systematic reviews.
